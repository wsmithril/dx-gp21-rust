...
impl core::convert::TryFrom<u32> for BaudRate {
    ...
    fn try_from(bps: u32) -> Result<Self, ()> {
        Self::from_bps(bps).ok_or(())
    }
}

impl From<BaudRate> for u32 {
    fn from(r: BaudRate) -> u32 {
        r.bps()
    }
}
...
impl From<ConstellationMask> for u8 {
    fn from(m: ConstellationMask) -> u8 {
        m.0
    }
}
